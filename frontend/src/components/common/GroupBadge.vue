...
const labelClass = computed(() => {
  ...
  // 正常状态或无天数:统一品牌主题色。平台语义色保留在平台/类型徽章上,
  // 分组名本身已是区分信息,这里跟随全站主题(聚蚁二开)。
  return `${base} bg-primary-500/15 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300`
})
...
// Badge color: 统一跟随全站主题(聚蚁二开)。平台归属看平台/类型徽章。
