...
export default {
  channelMonitorV2: {
    ...
    status: {
      ...
      window7d: '最近一周',
      platforms: '{count} 个平台',
      activeModels: '{count} 个活跃模型',
      attentionCount: '{count} 个需关注',
      allHealthy: '全部健康',
      stale: '数据更新失败，当前展示可能已过期',
      retry: '重新加载',
      emptyTitle: '最近 24 小时暂无模型流量',
      emptyDescription: '模型产生请求后会自动出现在这里，无需手动刷新',
      stateHealthy: '健康',
      stateWarning: '需关注',
      stateCritical: '异常',
      stateUnknown: '样本不足',
      activeBuckets: '活跃区间',
      attentionBuckets: '需关注区间',
      viewHint: '悬停或点击色块查看区间明细',
    },
