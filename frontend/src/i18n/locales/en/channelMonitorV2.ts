...
export default {
  channelMonitorV2: {
    ...
    status: {
      ...
      activeModels: '{count} active models',
      attentionCount: '{count} need attention',
      allHealthy: 'All healthy',
      stale: 'Refresh failed — the current view may be outdated',
      retry: 'Reload',
      emptyTitle: 'No model traffic in the last 24 hours',
      emptyDescription: 'Models appear here automatically once they receive requests',
      stateHealthy: 'Healthy',
      stateWarning: 'Watch',
      stateCritical: 'Critical',
      stateUnknown: 'Low samples',
      activeBuckets: 'Active buckets',
      attentionBuckets: 'Watch buckets',
      viewHint: 'Hover or tap a block for interval details',
    },
